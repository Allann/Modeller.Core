...
namespace Hy.Modeller.Domain.Extensions
{
    public static class ModelExtensions
    {
        ...
        public static Model AddRelation(this Model model, string[] principalFields, string dependant, string[] dependantFields, RelationshipTypes principalType = RelationshipTypes.One, RelationshipTypes dependantType = RelationshipTypes.Many, string linkTable = null)
        {
        ...
        public static Model AddFieldBool(this Model model, string name, string @default = null, bool nullable = false)
        {
            model.Fields.Add(new Field(name) { Default = @default, DataType = DataTypes.Bool, Nullable = nullable });
            return model;
        }
